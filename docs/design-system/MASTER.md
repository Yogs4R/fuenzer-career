...
**Project:** Fuenzer Career
**Generated:** 2026-08-03 17:21:04
...
- LinkedIn-inspired professional theme. Deep professional blue (#0A66C2), crisp white, light gray (#F3F5F7). Clean, modern, corporate feel with generous whitespace and card-based layout. Trustworthy and authoritative.
...
@theme {
  ...
  --color-secondary: oklch(0.3717 0.0392 257.29);
  --color-accent: oklch(0.5 0.1193 242.75);
  --color-background: oklch(0.9842 0.0034 247.86);
  --color-foreground: oklch(0.1288 0.0406 264.7);
  --color-muted: oklch(0.9415 0.008 253.85);

...
export default function SignUp() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : t("signup.error.googleFailed");
      setError(msg);
    } finally {
      setLoading(false);
    }
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl border border-border shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="font-heading text-2xl font-bold text-foreground">{t("signup.heading")}</h1>
          ...
          >
            ...
            {loading ? t("signup.redirecting") : t("signup.googleBtn")}
          </button>
